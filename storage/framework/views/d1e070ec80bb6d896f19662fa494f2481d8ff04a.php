    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <table class="table table-striped table-bordered" id="tabela">
                ...
                <tbody>
                <?php foreach($listarTurmas as $cr): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href='<?php echo e(url("frequencia/chamada/$cr->id")); ?>' class="btn btn-info btn-sm">Realizar chamada</a>
                        &nbsp; | &nbsp;
                        <a href='<?php echo e(url("frequencia/listarchamadas/$cr->id")); ?>' class="btn btn-warning btn-sm">Chamadas anteriores</a>
                    </td>
                </tr>
